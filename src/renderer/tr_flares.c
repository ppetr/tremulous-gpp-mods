 ...
 */
	...
	tess.vertexPtr2[0].fogNum = 1.0f;
	tess.vertexPtr1[0].tc1[0] = 0.0f;
	tess.vertexPtr1[0].tc1[1] = 0.0f;
	tess.vertexPtr3[0].color[0] = iColor[0];
	tess.vertexPtr3[0].color[1] = iColor[1];
	tess.vertexPtr3[0].color[2] = iColor[2];
	tess.vertexPtr3[0].color[3] = 255;

	tess.vertexPtr2[1].xyz[0] = f->windowX - size;
	tess.vertexPtr2[1].xyz[1] = f->windowY + size;
	tess.vertexPtr2[1].xyz[2] = 0.0f;
	tess.vertexPtr2[1].fogNum = 1.0f;
	tess.vertexPtr1[1].tc1[0] = 0.0f;
	tess.vertexPtr1[1].tc1[1] = 1.0f;
	tess.vertexPtr3[1].color[0] = iColor[0];
	tess.vertexPtr3[1].color[1] = iColor[1];
	tess.vertexPtr3[1].color[2] = iColor[2];
	tess.vertexPtr3[1].color[3] = 255;

	tess.vertexPtr2[2].xyz[0] = f->windowX + size;
	tess.vertexPtr2[2].xyz[1] = f->windowY + size;
	tess.vertexPtr2[2].xyz[2] = 0.0f;
	tess.vertexPtr2[2].fogNum = 1.0f;
	tess.vertexPtr1[2].tc1[0] = 1.0f;
	tess.vertexPtr1[2].tc1[1] = 1.0f;
	tess.vertexPtr3[2].color[0] = iColor[0];
	tess.vertexPtr3[2].color[1] = iColor[1];
	tess.vertexPtr3[2].color[2] = iColor[2];
	tess.vertexPtr3[2].color[3] = 255;

	tess.vertexPtr2[3].xyz[0] = f->windowX + size;
	tess.vertexPtr2[3].xyz[1] = f->windowY - size;
	tess.vertexPtr2[3].xyz[2] = 0.0f;
	tess.vertexPtr2[3].fogNum = 1.0f;
	tess.vertexPtr1[3].tc1[0] = 1.0f;
	tess.vertexPtr1[3].tc1[1] = 0.0f;
	tess.vertexPtr3[3].color[0] = iColor[0];
	tess.vertexPtr3[3].color[1] = iColor[1];
	tess.vertexPtr3[3].color[2] = iColor[2];
	tess.vertexPtr3[3].color[3] = 255;
